...
const Circulo = ({ onPress , animatedValue }) => {
  ...
  return (
    <Animated.View style={[StyleSheet.absoluteFillObject, styles.containerCirculo, {backgroundColor: animatedBackground}]}>
      ...
      >Frases importante sobre React Native e o conceito de animações</Animated.Text>
...
O objetivo retornado persistirá durante todo o ciclo de vida do componente.
*/
